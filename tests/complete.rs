...
use php_codegen::enum_case::EnumCase;
...
fn test_code_generation() {
    let file = File::new()
        ...
        .r#enum(
            Enum::new("ExampleUnitEnum")
                .document(Document::new().text("This is an example unit enum."))
                .using("A")
                .using(vec!["B", "C"])
                .using(
                    Usage::new(vec![
                ...
                .case(EnumCase::new("Foo").document(Document::new().text("This is a foo case.")))
                .case(EnumCase::new("Bar").document(Document::new().text("This is a bar case.")))
                .case("Baz"),
        )
        .r#enum(
            Enum::new("ExampleStringBackEnum")
                .document(Document::new().text("This is an example string backed enum."))
                .string_backed()
                .case(
                    EnumCase::new("Foo")
                        .document(Document::new().text("This is a foo case."))
                        .valued("foo value"),
                )
                .case(
                    EnumCase::new("Bar")
                        .document(Document::new().text("This is a bar case."))
                        .valued("bar value"),
                )
                .case(("Baz", "baz value")),
        )
